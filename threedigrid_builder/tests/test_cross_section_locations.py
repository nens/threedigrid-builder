...
def locations():
    return CrossSectionLocations(
        ...
        vegetation_stem_density=[1, 0.3, 0.4, 0.02, 0.03],
        vegetation_stem_diameter=[0.5, 0.5, 0.5, 0.3, 0.4],
        vegetation_height=[0.2, 1, 1, 1, 3],
        vegetation_drag_coefficient=[1, 1, 1, 1, 1],
