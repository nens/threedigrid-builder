...
class LineType(IntEnum):  # for kcu (calculation_type of a line)
    ...
    LINE_2D_GROUNDWATER_BOUNDARY_WEST = -200
    LINE_2D_GROUNDWATER_BOUNDARY_EAST = -300
    LINE_2D_GROUNDWATER_BOUNDARY_SOUTH = -400
    LINE_2D_GROUNDWATER_BOUNDARY_NORTH = -500
